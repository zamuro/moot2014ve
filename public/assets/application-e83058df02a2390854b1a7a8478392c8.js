...
(function() {
  jQuery(function() {
    ...
    return $('#datos_registro_region_id').change(function() {
      var escaped_region, grupos, options, region;
      ...
      if (options) {
        ...
        return $('#datos_registro_distrito_id').change(function() {
          var distrito, escaped_distrito;
