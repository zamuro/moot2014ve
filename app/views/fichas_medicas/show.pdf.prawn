...
prawn_document(:page_size => "A4") do |pdf|
	pdf.text "Planilla de inscripción CAREPAS 2014 Región Metropolitana", :style => :bold, :size => 30, :align => :center
	pdf.move_down(10)
	pdf.text "Datos del participante", :size => 20, :align => :left
	pdf.table([
		["Nombre", "#{@datos_registro.nombre}", "Fecha de nacimiento", "#{@datos_registro.fechaNac}"],
	],
	:width => 500)
	pdf.table([
